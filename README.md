...
- [Jinja Template - Black Docs](https://docs.appseed.us/jinja-template/jinja-template-black-dashboard/)
...
## UI Kit - [Black Dashboard](https://appseed.us/black-dashboard)

*Vendor Notes* - **[Black Dashboard](https://appseed.us/black-dashboard)** is a beautiful Bootstrap 4 Admin Dashboard with a huge number of components built to fit together and look amazing.
